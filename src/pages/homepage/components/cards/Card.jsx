    ...
    return (
        <div ref={container} className="h-[60vh] lg:h-[70vh] flex items-center justify-center sticky top-0">
            <motion.div
                ...
                <div className="grid lg:grid-cols-7 h-full gap-[50px]">
                    <div className="description relative lg:top-[10%] py-[50px] px-6 lg:pl-[50px] z-10 col-span-3">
                        <h2 className='text-[40px] leading-[45px] lg:text-[60px] lg:leading-[60px]'>{title}</h2>
                        <p className='lg:text-[20px] lg:leading-[24px] mt-4 helvetica-regular w-full'>{description}</p>
                    </div>

                    <div className="relative rounded-[25px] overflow-hidden lg:col-span-4 h-full">
