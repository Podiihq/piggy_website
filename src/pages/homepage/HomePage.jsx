...
const HomePage = () => {
    ...
    return (
        <div className='max-w-screen-lg mx-auto text-[#171717]'>
            ...
            <section className='pt-72 pb-32 cursor-pointer'>
                <div className='h-[600px] bg-[#f4f4f4] border-[#f9f9f9] border-8 rounded-[30px] relative'>
                ...
                <div className='mt-8'>
                    <div className='grid grid-cols-5 gap-[10px]'>
                        <div className='col-span-3'>
                            <div className='flex gap-2 bg-[#f9f9f9] rounded-[30px] px-6 pt-6 h-[400px]'>
                                <div className=''>
                        ...
                        <div className='bg-[#f9f9f9] rounded-[30px] px-6 pt-6 col-span-2 flex flex-col'>
            ...
            <section className='py-32'>
                <div className='px-6 py-16 bg-[#f9f9f9] rounded-[30px]'>
                    <div>
                        <img src={Logo} alt="" className='mx-auto w-28' />
                        <p className='text-[60px] helvetica-bold leading-[70px] text-center w-2/3 mx-auto'>
