                ...
                <div className='grid lg:grid-cols-2 items-center mt-20 lg:mt-32 max-w-screen-lg mx-auto'>
                    <div className='flex flex-col gap-2 md:w-4/5 lg:w-full mx-auto'>
                        ...
                        <div className='flex gap-3 justify-center lg:justify-start'>
                            <button onClick={() => setIsOpen(true)} className="relative px-6 py-2.5 lg:px-8 lg:py-3.5 text-white font-bold rounded-full bg-gradient-to-r via-[#5BA4BB] from-[#9AC7D5] to-[#4F8DA1] hover:from-[#4F8DA1] hover:to-[#9AC7D5] transform hover:scale-105 transition-all duration-300">
                    ...
                    <div className='px-6 py-16  bg-[#f9f9f9] rounded-[30px] w-full max-w-screen-lg mx-auto '>
                        <div>
                            ...
                            <div className='flex justify-center pt-10'>
                                <button onClick={() => setIsOpen(true)} className="relative px-8 py-3 text-white font-bold rounded-full bg-gradient-to-r from-[#EAC870] via-[#DEA81E] to-[#BF8D10] hover:from-[#BF8D10] hover:to-[#EAC870] transform hover:scale-105 transition-all duration-300">
                                    <span className="absolute inset-0 bg-gradient-to-r from-[#EAC870] via-[#DEA81E] to-[#BF8D10] opacity-75 blur-sm rounded-full"></span>
                                    <span className="relative z-10">Join Waiting List</span>
                                </button>
                            </div>
